...
const FEATURES = [
  {
    icon: Zap,
    title: '자동 주문 수집',
    description: '스마트스토어, 쿠팡 주문을 30분 주기로 자동 수집합니다.',
  },
  {
    icon: RefreshCw,
    title: 'ERP 자동 연동',
    description: '이카운트 ERP에 매출전표를 자동으로 생성합니다.',
  },
  {
    icon: Shield,
    title: '정산 자동화',
    description: '마켓별 수수료를 자동 계산하고 정산 전표를 생성합니다.',
  },
  {
    icon: BarChart3,
    title: '송장 자동 반영',
    description: '송장번호를 업로드하면 마켓에 자동으로 반영됩니다.',
  },
];
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-6 text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto">
            스마트스토어, 쿠팡 주문 수집부터 ERP 전표 생성, 송장 반영까지<br />
            모든 과정을 자동화하여 운영 비용을 절감하세요.
          </p>
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/register">
              <Button size="lg" className="bg-gray-900 hover:bg-gray-800 text-base px-8 h-12">
                무료로 시작하기
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { step: '01', title: '스토어 연동', desc: '스마트스토어, 쿠팡 API 키를 등록하세요.' },
              { step: '02', title: 'ERP 연동', desc: '이카운트 인증 정보를 입력하세요.' },
              { step: '03', title: '자동화 시작', desc: '나머지는 SellSync가 알아서 처리합니다.' },
            ].map((item, index) => (
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="divide-y divide-gray-100">
              {PRICING.map((plan, index) => (
                <div key={index} className="flex items-center justify-between p-6 hover:bg-gray-50 transition-colors">
                  ...
                  <span className="text-2xl font-bold text-gray-900">{plan.price}<span className="text-sm font-normal text-gray-500">/월</span></span>
                </div>
              ))}
            </div>
          </div>
          <div className="mt-8 text-center">
            <p className="text-gray-600 mb-6">
              모든 요금제에 포함: 주문 수집 / ERP 전표 생성 / 정산 자동화 / 송장 반영
            </p>
            <Link href="/register">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            14일 무료 체험으로 SellSync의 모든 기능을 경험해보세요.<br />
            신용카드 없이 바로 시작할 수 있습니다.
          </p>
          <Link href="/register">
            <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-base px-10 h-12">
              무료로 시작하기
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
          </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-600">© 2026 SellSync. All rights reserved.</span>
            </div>
